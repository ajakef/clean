...
clean.plot_freq_slow_spec(result, 'fx', fRange = [0,10], ax = ax[0])
clean.plot_freq_slow_spec(result, 'fx', type = 'original', fRange=[0,10], ax = ax[1])
clean.plot_freq_slow_spec(result, 'xy', type = 'original', fRange=[0,10], ax = ax[2])
plt.tight_layout()
...
clean.plot_freq_slow_spec(result, 'xy', ax = ax[0,0])
clean.plot_freq_slow_spec(result, 'xy', 'original', ax = ax[0,1])
clean.plot_freq_slow_spec(result, 'fx', ax = ax[1,0])
clean.plot_freq_slow_spec(result, 'fx', 'original', ax = ax[1,1])
plt.tight_layout()
